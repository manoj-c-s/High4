...
function LoginPage() {
  ...
  return (
    <div className='flex w-full items-center justify-center h-screen'>
      {showToast && (
        <FormWarning message='Please enter Registered Email and password to continue.' />
      )}
      {showToast2 && (
        <FormWarning message='Please verify your email and password to ensure they are entered correctly. ' />
      )}
      ...
      {/* <div className='hidden relative w-1/2 h-full lg:flex items-center justify-center bg-gray-200'>
        <img src={logo} alt='' className='w-300' />
